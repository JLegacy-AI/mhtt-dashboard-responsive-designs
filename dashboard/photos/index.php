...
<aside id="sidebar" class="sidebar">
            ...
            <div class="row">
              ...
              <div class="col-xxl-4 col-md-6 ">
                <div class="card info-card sales-card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Date <span>| Sep 1, 3:52 PM</span></h5>

                    <div class="d-flex align-items-start">
                      <img class="mr-2 mb-2" src="./../../assets/img/product-1.jpg" alt="Project Photo" style="height: 150px; width: 150px;">
                      <div class="ps-3">
                        <h6>Machine Learning Sentiment Analysis</h6>
                        <div>
                          <h5  class="card-title d-flex align-items-center "> <i class='bx bxs-purchase-tag text-primary '></i> Tags</h5>
                          <div class="d-block">
                              <span class="badge bg-secondary fw-light text-capitalize mr-2"><i class='bx bxs-purchase-tag text-light '></i> jamal</span>
                              <span class="badge bg-secondary fw-light text-capitalize mr-2"><i class='bx bxs-purchase-tag text-light '></i> jamal</span>
                              <span class="badge bg-secondary fw-light text-capitalize mr-2"><i class='bx bxs-purchase-tag text-light '></i> jamal</span>
                              <a class="btn btn-primary fw-light text-capitalize mr-2"><i class='bx bx-plus' ></i></a>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="modal fade rounded-0" id="addPhotoModal" tabindex="-1" aria-labelledby="addPhotoModalLabel" aria-hidden="true">
