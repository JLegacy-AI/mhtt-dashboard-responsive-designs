        ...
        <div class="row">
            <div class="card overflow-auto">
                  <div class="card-body row">
                    ...
                    <div class="col-md-8 col-sm-12 d-flex justify-content-center align-items-center bg-light p-5 position-relative">
                        <button class="btn btn-primary position-absolute" style="top:10px; left: 10px;" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <i class="bi bi-pencil-square"></i>
                        </button>
                        <img class="img-thumbnail" src="../../../assets/img/product-2.jpg" alt="">
                    </div>
                    <div class=" col-md-4 col-sm-12">
                        <form id="project-add-form" class="row g-3 needs-validation" novalidate>
                            <div class="col-12">
                                <p class="fs-4 py-0 my-0 ">Machine Learning Sentiment Analysis</p>
                                <p class="overflow-hidden text-nowrap text-muted col-10 fw-medium py-0" style="font-size:12px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore hic eius recusandae natus distinctio earum quod consequatur totam quis ex, sunt, odio explicabo sed est consequuntur repudiandae odit? Mollitia, tempora?</p>
                            </div>
                            <div class="col-12 row">
                                <a href="#">
                                    <i class="bi bi-tags-fill"></i> Add Tags
                                </a>
                                <div class="col-12 py-2">
                                    <span class="badge text-dark img-thumbnail fw-normal "><i class="bi bi-tag pe-2 "></i>Light</span>
                                    <span class="badge text-dark img-thumbnail fw-normal "><i class="bi bi-tag pe-2 "></i>Light</span>
                                    <span class="badge text-dark img-thumbnail fw-normal "><i class="bi bi-tag pe-2 "></i>Light</span>
                                    <span class="badge text-dark img-thumbnail fw-normal "><i class="bi bi-tag pe-2 "></i>Light</span>
                                </div>
...
<div class="modal fade rounded-0" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    ...
    <script type="text/javascript" src="https://github.com/nhn/tui.image-editor/blob/master/apps/image-editor/examples/js/theme/black-theme.js"></script>
    <!-- <script type="text/javascript" src="https://nhn.github.io/tui.image-editor/blob/master/apps/image-editor/examples/js/theme/white-theme.js"></script> -->
