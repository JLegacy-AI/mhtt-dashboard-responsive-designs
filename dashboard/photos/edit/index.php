...
<head>
  ...
  <link type="text/css" href="https://nhn.github.io/tui.image-editor/latest/dist/tui-image-editor.css"
    rel="stylesheet" />
...
<body>
      ...
      <div class="row">
        <div class="card overflow-auto">
          <div class="card-body row">
            ...
            <div class="col-12 d-flex justify-content-center align-items-center bg-light p-5 position-relative">
              <?php
              echo '<button
                          id="editPhoto"
        ...
        <div class="card recent-sales overflow-auto col-12 col-md-5">
          <div class="card-body">
            <h2 class="card-title fs-2">
              Description <span id="show-description-characters">|
                <?php echo strlen($photo['description']) ?> Characters
              </span>
            </h2>
            <div class="form-floating">
              <textarea id="photo-description" class="form-control" placeholder="Leave a Description here"
                id="descriptionTextArea"><?php echo $photo['description'] ?></textarea>
  ...
  <div class="modal fade rounded-0" id="toast-image-editor-modal" tabindex="-1"
    aria-labelledby="toast-image-editor-modal-label" aria-hidden="true">
