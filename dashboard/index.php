                ...
                <div class="card info-card sales-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-column col-md-6">
                        ...
                        <div >
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <img class="mr-2 mb-2" src="./../assets/img/product-1.jpg" alt="Project Photo" style="height: 80px; width: 80px;">
                            <div>
                                <div class="bg-light d-inline-flex justify-content-center align-items-center mr-2 mb-2" style="width: 80px; height: 80px;">
