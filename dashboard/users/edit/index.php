  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
          <div class="d-flex">
            <h1 id="editableFirstName" class="outline-none m-0 p-0" style="color: #012970">
              <?php
              ...
              <button class="btn btn-link editableButton" data-column="firstName" contenteditable="false"
                data-target="#editableFirstName" data-url="<?php echo $userwiki ?>">
                <i class="bx bx-edit fs-5 text-primary"></i>
              </button>
            </h1>
            <p id="editableLastName" class="outline-none m-0 p-0 fs-2" style="color: #012970; font-style: 'Poppins'">
              <?php
              ...
              <button class="btn btn-link editableButton" data-column="lastName" contenteditable="false"
                data-target="#editableLastName" data-url="<?php echo $userwiki ?>">
                <i class="bx bx-edit fs-5 text-primary"></i>
              </button>
            </p>
          </div>
          <div class="d-flex flex-column justify-content-start align-items-start">
            <p id="editableEmail" class="outline-none d-flex flex-row-reverse align-items-center m-0 p-0"
              style="color: #012970">
              <?php
              ...
              ?>
              <button class="btn btn-link editableButton" contenteditable="false" data-column="email"
                data-target="#editableEmail" data-url="<?php echo $userwiki ?>">
                <i class="bx bx-edit fs-5 text-primary"></i>
              </button>
            </p>
            <p id="editablePhoneNumber" class="outline-none d-flex flex-row-reverse align-items-center m-0 p-0"
              style="color: #012970">
              <?php
              ...
              <button class="btn btn-link editableButton" contenteditable="false" data-column="phoneNumber"
                data-target="#editablePhoneNumber" data-url="<?php echo $userwiki ?>">
                <i class="bx bx-edit fs-5 text-primary"></i>
              </button>
            </p>
          </div>
                      ...
                      <div id="flush-collapseOne" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                          <form id="project-add-form" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-12">
                              <div class="input-group has-validation">
                                <input type="password" name="address" class="form-control" id="confirmPassword"
                            ...
                            <div class="col-12">
                              <button class="btn btn-primary w-100" type="submit" data-url="<?php echo $userwiki ?>">
                                Save Changes
                              </button>
                            </div>
                          </form>
                  ...
                  <div class="d-flex justify-content-center flex-column align-items-center">
                    ...
                    <div
                      ...
                      <input type="file" class="position-absolute w-100 h-100 opacity-0"
                        style="cursor: pointer; height: 300px" name="" id="" />
                    </div>
